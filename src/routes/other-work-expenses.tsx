...
export const Route = createFileRoute('/other-work-expenses')({
  component: OtherWorkExpensesPage,
});

function OtherWorkExpensesPage() {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold">D5 Other Work-Related Expenses</h1>
                <p className="text-sm text-muted-foreground">
                  Workpaper for miscellaneous work expenses
                </p>
              </div>
            </div>
            <div className="flex items-center gap-3">
